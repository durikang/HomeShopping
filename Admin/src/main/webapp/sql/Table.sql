...
CREATE TABLE BOARD_IMAGE (
    IMAGE_NO NUMBER PRIMARY KEY,  -- 사진의 고유 번호
    BOARD_NO NUMBER,  -- 게시글 번호 (BOARD 테이블 참조)
    IMAGE_URL VARCHAR2(255) NOT NULL,  -- 사진의 파일 경로 또는 URL
    DESCRIPTION VARCHAR2(255),  -- 사진에 대한 설명 (선택)
    UPLOADED_AT DATE DEFAULT SYSDATE,  -- 사진 업로드 날짜
    FOREIGN KEY (BOARD_NO) REFERENCES BOARD(BOARD_NO)  -- BOARD 테이블의 BOARD_NO와 연결되는 외래키
);
